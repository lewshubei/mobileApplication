...
class AppointmentService {
  ...
  Future<List<Map<String, dynamic>>> getAppointmentsForCounselor(
      String counselorId, String statusFilter) async {
    try {
      ...
      for (var doc in appointmentSnapshot.docs) {
        ...
        if (clientDoc.exists) {
          ...
          if (clientData != null && clientData['role'] == 'student') {
            ...
            appointmentData['dateTime'] = (appointmentData['datetime'] as Timestamp).toDate();
  ...
  Future<List<Map<String, dynamic>>> searchAppointmentsByClientName(
      String counselorId, String statusFilter, String searchQuery) async {
    try {
