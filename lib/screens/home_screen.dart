...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _shareAssessmentAsPdf(Map<String, dynamic> assessment) async {
    try {
      ...
      final file = File(
        '${directory.path}/mood_assessment_${DateTime.now().millisecondsSinceEpoch}.pdf',
      );
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    '60-79%: Moderate mental wellbeing - consider seeking support',
                  ),
                  pw.Text(
                    '80-100%: Poor mental wellbeing - professional help recommended',
                  ),
                ],
              ),
            ),
